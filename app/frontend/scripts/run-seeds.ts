...
async function runAllSeeds() {
  ...
  try {
    ...
    console.log(`   - Productos: ${tierraGresResult.stats.productos}`);
    console.log(`   - Stock Total: ${tierraGresResult.stats.stockTotal} piezas`);
    console.log(`   - Valor Venta: $${tierraGresResult.stats.valorVenta.toLocaleString('es-CL')}`);
    console.log(`   - Margen: $${tierraGresResult.stats.margen.toLocaleString('es-CL')}`);
    ...
    console.log(`   - Productos: ${joyasRelmuResult.stats.productos}`);
    console.log(`   - Stock Total: ${joyasRelmuResult.stats.stockTotal} piezas`);
    console.log(`   - Valor Venta: $${joyasRelmuResult.stats.valorVenta.toLocaleString('es-CL')}`);
    console.log(`   - Margen: $${joyasRelmuResult.stats.margen.toLocaleString('es-CL')}`);
    ...
    console.log(`   - ${tierraGresResult.stats.productos + joyasRelmuResult.stats.productos} productos marketplace creados`);
